          ...
          <Col xl={3} lg={6} md={12} xs={12} className="mt-6" key={1}>
            <Card>
              <Card.Body>
                ...
                <div>
                  <p>
                    This bot is based on supertrend analysis. This bot is based on supertrend analysis. This bot is based on supertrend analysis. This bot is based on supertrend analysis. This bot is based on supertrend analysis.
                  </p>
                </div>
                <div>
