...
import { Col, Row, Container, Table, FormCheck, FormControl } from 'react-bootstrap';
  ...
  return (
    <Container fluid className="p-6">
      ...
      <Row className='flex-end'>
        <Col xxl={4} lg={4} md={8} xs={12} className='align-right'>
          <FormControl type="search" placeholder="Asset name" />
        </Col>
      </Row>
